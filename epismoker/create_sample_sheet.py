...
# open pheno data
ss = pd.read_csv("GSE51032/GSE51032_all_phenotype.csv")
...
# just select female
ss_filter = ss_filter[ss_filter["Gender"] == "f"]
...
output.to_csv("GSE51032/idat/normal_mama/samplesheet_GSE109381_simple.csv", index=False)
