...
data = "../download_geo/GSE51032/GSE51032_bvalues_filtered_pheno_factor.csv"
df = pd.read_csv(data)
...
result_df.to_csv("../download_geo/GSE51032/GSE51032_beamsearch_result_dp100_sz50_nodiagnosis.csv", index=False)