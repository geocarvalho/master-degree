...
classes = classes.set_index("samples")
...
merged_df = merge_chunks_df.merge(classes, left_index=True, right_index=True)

# setup pycaret with dataset
clf = pc.setup(data=merged_df, target="class_num")
pc.compare_models()